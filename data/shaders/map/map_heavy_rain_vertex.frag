...
void main()
{
    ...
    v_TexCoord2 = (u_MapCoords + (v_TexCoord * b) + (rainDirection * u_GlobalTime * rainSpeed) / u_Resolution) * 1.5;
    v_TexCoord3 = (u_MapCoords + (v_TexCoord * b2) + (fogDirection * u_GlobalTime * fogSpeed) / u_Resolution) * 0.8;
}
