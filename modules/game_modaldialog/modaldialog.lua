...
local buttonConfig = {
  ["Cancel"] = "/images/newui/btnred_small",
  ["Confirm"] = "/images/newui/btngreen_small",
  ["Select"] = "/images/newui/btngreen_small",
  ["Set Level"] = "/images/newui/btngreen_small",
}
...
function onModalDialog(id, title, message, buttons, enterButton, escapeButton, choices, priority)
  ...
  modalDialog.title:setText(title)
  ...
  buttonsPanel:setMarginRight(marginRight)
  messageLabel:setTextWrap(true)
  
  modalDialog:setHeight(200 + additionalHeight + messageLabel:getHeight())
