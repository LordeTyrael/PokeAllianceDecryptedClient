...
function init()
  --statsButton = modules.client_topmenu.addLeftButton('statsButton', 'Debug Info', '/images/ui/topbuttons/icons/debug', toggle)
...
function toggle()
-- comentado para remover debug.info (temporario)
