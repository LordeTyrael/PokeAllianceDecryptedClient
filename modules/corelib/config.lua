...
print = function(value)
    ...
    if valueType == "function" then
        oldPrint("Function: " .. tostring(value))
    elseif valueType == "boolean" then
        oldPrint("Boolean: " .. tostring(value))
    elseif valueType == "string" then
        oldPrint("String: " .. value)
    elseif valueType == "number" then
        oldPrint("Number: " .. value)
    elseif valueType == "table" then
        oldPrint("Table: ")
        printTable(value, "  ")
    elseif valueType == "userdata" then
        oldPrint("Userdata: " .. tostring(value))
        ...
        oldPrint("Other: (" .. valueType .. ") " .. tostring(value))
    end
end
...
function printTable(tbl, indent)
    ...
    for key, val in pairs(tbl) do
        if type(val) == "table" then
            oldPrint(indent .. tostring(key) .. ": ")
            printTable(val, indent .. "  ")
        else
            oldPrint(indent .. tostring(key) .. ": " .. tostring(val))
        end
    end
end