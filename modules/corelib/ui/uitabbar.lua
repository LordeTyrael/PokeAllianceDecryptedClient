...
function UITabBar:addTab(text, panel, icon, useSelfSize)
  if panel == nil then
  ...
  local width = useSelfSize and tab:getWidth() or tab:getTextSize().width
  tab:setWidth(width + tab:getPaddingLeft() + tab:getPaddingRight())
