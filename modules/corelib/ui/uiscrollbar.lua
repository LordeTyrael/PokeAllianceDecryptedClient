...
local function calcValues(self)
  ...
  local px = math.max(proportion * pxrange, 16)
...
local function updateSlider(self)
  -- setters can re-enter during widget teardown (e.g. UITextEdit's
  -- onTextAreaUpdate fires while the window is being destroyed)
