...
-- Espelha DuelShield_t do servidor (src/const.h) e Otc::DuelShields (src/client/const.h).
-- O byte ja vinha na descricao de criatura; faltava so o nome no lado Lua.
DuelShieldNone = 0
DuelShieldLeader = 1
DuelShieldTeammate = 2
DuelShieldInvited = 3
DuelShieldInviting = 4
DuelShieldOpponent = 5
DuelShieldParticipant = 6
...
FightModeInfo = {
  ["!offensive"] = {fightmode = 1},
  ["!balanced"] = {fightmode = 2},
  ["!defensive"] = {fightmode = 3}
}
...
InventorySlotOrder = 4
InventorySlotPokedex = 6