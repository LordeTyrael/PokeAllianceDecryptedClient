...
function ProtocolLogin:sendLoginPacket()
  ...
  msg:addU16(ClientOpcodes.ClientEnterAccount)
  ...
  msg:addString(g_crypt.getMachineUUID())
  msg:addString(g_game.getServerVersion())
...
function ProtocolLogin:parseCharacterList(msg)
  ...
  for i=1,charactersCount do
    ...
    character.icon = msg:getU16()
    character.level = msg:getU32()
    character.sex = msg:getU8()
    character.balance = msg:getU64()
    character.guildIcon = msg:getU16()
    character.guildName = msg:getString()
    character.experience = msg:getU32()
    character.experiencePercent = msg:getU8()
    character.fishingSkill = msg:getU32()
    character.fishingPercent = msg:getU8()
    character.headbuttSkill = msg:getU32()
    character.headbuttPercent = msg:getU8()
    character.rockSmashSkill = msg:getU32()
    character.rockSmashPercent = msg:getU8()

    character.pokeballs = {}
    local pokeballsCount = msg:getU8()
    for i = 1, pokeballsCount do
      local pokeballInfo = {}
      pokeballInfo.pokeball = msg:getString()
      pokeballInfo.pokemon = msg:getString()
      pokeballInfo.boost = msg:getU8()
      table.insert(character.pokeballs, pokeballInfo)
    end
...
function getLocale()
  ...
  if not userLocaleName or userLocaleName == 'false' then
    userLocaleName = 'en'
  end
  ...
  print(string.format("[locale protocollogin] cannot send undefined locale: %s", userLocaleName))
  return "en"
end