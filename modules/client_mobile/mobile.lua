...
function init()
  ...
  zoomInButton = modules.client_topmenu.addLeftButton('zoomInButton', tr('Zoom In'), '/images/topbuttons/zoomin', function() g_app.scaleUp() end)
  zoomOutButton = modules.client_topmenu.addLeftButton('zoomOutButton', tr('Zoom Out'), '/images/topbuttons/zoomout', function() g_app.scaleDown() end)
  keypadButton = modules.client_topmenu.addLeftGameToggleButton('keypadButton', tr('Keypad'), '/images/topbuttons/keypad', function()
